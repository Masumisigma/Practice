...
-->
<?php if ($_SERVER['REQUEST_URI']=='/favicon.ico') exit(''); ?>
				...
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							...
							<?php /*if(isset($_SESSION['ID'])) {*/?><a class="button2" href="product.php">Shop Now </a> <?php /*} else { */?><!-- <script> alert("Sorry ! You are not Logged In");</script>--><?php /*} */?>
						</div>
					</div>
				</div>
			</div>
