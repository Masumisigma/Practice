...
namespace Task3\ExtraCheckoutAddressFields\Setup\Patch\Data;
...
class AddExampleAttribute implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $eavSetup->addAttribute('customer_address', 'example', [
        ...
        $customAttribute = $this->eavConfig->getAttribute('customer_address', 'example');
